...
const SellerLanding = () => {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Sell Online with Flipkart</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-20">
                ...
                <div className="p-6">
                    ...
                    <p className="text-gray-500 text-sm">Access to millions of customers who trust Flipkart.</p>
                </div>
            </div>
        </div>
    );
